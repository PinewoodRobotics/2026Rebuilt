...
import frc4765.proto.status.Frontend.PIDFFUpdateMessage;
...
public class AutoUpdatingConstants {
  ...
  public static double kGeneralP = 1.0;
  public static double kGeneralI = 0.01;
  public static double kGeneralD = 1.0;
